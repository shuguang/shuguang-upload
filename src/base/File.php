...
class File extends SplFileObject
{
    ...
    protected function autoBuildName()
    {
        if ($this->rule instanceof \Closure) {
            ...
            switch ($this->rule) {
                case 'Ymd':
                    $savename = date('Y/m/d') . DIRECTORY_SEPARATOR . md5(microtime(true));
                    break;
                case 'Ym':
                    $savename = date('Y/m') . DIRECTORY_SEPARATOR . md5(microtime(true));
                    break;
                case 'Y':
                    $savename = date('Y') . DIRECTORY_SEPARATOR . md5(microtime(true));
                    break;
                case 'date':
